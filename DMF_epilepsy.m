function [fc, frN]=DMF_epilepsy(scPath,fic,ffi,simTime,dt,G,noiseAmp,lesionAreas,ficWeights,setFICWeights)
...
%lesionArea : Index of the area which is lesioned in the SC
