function [fc, maxfrN]=DMF_lesioned(scPath,scName,fic,ffi,simTime,dt,G,noiseAmp,lesionAreas,ficWeights,setFICWeights)
%%
%scPath          : Path to structural connectivity(SC) matrix file
%scName          : SC matrix path in the given hdf5 file
%fic             : true or false
%ffi             : true or false
